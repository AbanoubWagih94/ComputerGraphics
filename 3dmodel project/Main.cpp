...
void drawScene(void){
	...
	if (labelsActive == 1){
		...
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Sun");
	}
	glPushMatrix();
	...
	if (labelsActive == 1){
		...
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Mercury");
	}
	glPushMatrix();
	...
	if (labelsActive == 1){
		glRasterPos3f(0.0, 3, 0.0);
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Venus");
	}
	glPushMatrix();
	...
	if (labelsActive == 1){
		glRasterPos3f(0.0, 3, 0.0);
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Earth");
	}
	glPushMatrix();
	...
	if (labelsActive == 1){
		glRasterPos3f(0.0, 3, 0.0);
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Mars");
	}
	glPushMatrix();
	...
	if (labelsActive == 1){
		...
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Jupiter");
	}
	glPushMatrix();
	...
	if (labelsActive == 1){
		glRasterPos3f(0.0, 4.4, 0.0);
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Uranus");
	}
	glPushMatrix();
	...
	if (labelsActive == 1){
		glRasterPos3f(0.0, 4.4, 0.0);
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Neptune");
	}
	glPushMatrix();
	...
	if (labelsActive == 1){
		...
		glColor3ub(255, 255, 255);
		writeBitmapString(GLUT_BITMAP_TIMES_ROMAN_24, "Pluto");
	}
	glPushMatrix();
...
{
	float x = 0, y = 0, z = 50;
	x = x + (500 * cos(a*3.14 / 360));
	y = y + (500 * sin(a*3.14 / 360));
	if (isAnimate == 1) {
		a = a + 1;
		aa = aa + 2;
	}
